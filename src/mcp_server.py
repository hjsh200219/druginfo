...
6. 의약품 코드 체계 이해 (참조: https://edb.atlassian.net/wiki/external/N2U4M2QxM2ZhNjNlNDBjZTlhMzJlNDVjMjEwMTAyYWI):
   ...
   - ProductCode(15자리): 터울 자체 생성 코드 (참조: https://edb.atlassian.net/wiki/external/MmFlOTg2ZDlkNzBiNGZlNGI0MjdjNWY5OWExNzNiYzU)
     ...
     * 예시: E201207542ATB7D (카나브정30밀리그램)
       ...
       - 7D: 구별용 난수
   - 요양기관기호(8자리): 심사평가원 발급 고유번호 (참조: https://edb.atlassian.net/wiki/external/MjgxNzc4YWM1YTc1NGRiMjk1ZjFiYmE2YjZiYzhiOWI)
     * 구조: 지역구분(2자리) + 종별구분(1자리) + 일련번호(4자리) + 체크번호(1자리)
     * 지역구분: 11-13(서울), 21(부산), 31,41(경기/인천), 32(강원), 33(충북), 34(대전/충남), 35(전북), 36(전남), 37(대구/경북), 38(경남), 39(제주)
     * 종별구분: 1(종합병원), 2(병원), 3(의원), 4(치과병원), 5(치과의원), 6(조산원), 7(보건소), 8(약국), 9(한의원)
     * 특별규칙: 요양병원은 3-4자리가 "28" (병원+요양병원구분자)
     * 예시: 12281234 (서울 소재 요양병원)
        """
...
10. 요양기관기호 해석:
    - 예시: 12281234 해석
      ...
      * 1234: 일련번호
      * 4: 체크번호
    - 활용: 지역별/종별 의약품 처방 패턴 분석, 약국(8) 식별 등
        """
